...
# Version 1.27 3.14
#       36. add Dot1xHost
# Version 1.28 2015.9.20
#       37. Support load from configuration file
...
class DhcpDualStackHost {
    ...
    constructor { port { onStack null } { hDhcpDualStackHost null } } {
	set dhcpv4 $this/dhcpv4
	set dhcpv6 $this/dhcpv6
	Deputs "create dhcpv4 host"		
	Dhcpv4Host $dhcpv4 $port $onStack $hDhcpDualStackHost
	set hDhcp [ $dhcpv4 cget -hDhcp ]
	Deputs "dhcp handle: $hDhcp"
	Deputs "create dhcpv6 host"	
	Dhcpv6Host $dhcpv6 $port $hDhcp $hDhcpDualStackHost
    }
